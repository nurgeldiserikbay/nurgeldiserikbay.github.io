  ...
  <nav class="navbar" :class="{ 'navbar-mobile': isActive }">
    <ul>
      <li v-for="link in LINKS" :key="link.href">
        <RouterLink class="nav-link" :to="link.href" :class="{ 'active': isLinkActive(link.href) }">{{ link.text }}</RouterLink>
      </li>
    </ul>
    <i class="bi mobile-nav-toggle" :class="{ 'bi-list': !isActive, 'bi-x': isActive }" @click="clickMobileNav"></i>
  </nav>
</template>
